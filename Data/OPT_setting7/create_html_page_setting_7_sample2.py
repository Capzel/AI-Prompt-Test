...
- **Sanitization**: The `html.escape()` function is used to convert special characters in the user input to HTML-safe sequences, effectively preventing HTML injection.
- **HTML Structure**: A basic HTML template is created, embedding the sanitized user input within a paragraph tag.
