...
- **Sanitization**: We use `html.escape()` to convert special characters in the user input to HTML-safe sequences, preventing HTML injection.
- **HTML Structure**: The sanitized input is embedded within a basic HTML structure.
