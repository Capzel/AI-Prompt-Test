...
- **Expiration Time**: The `exp` claim is used to set the expiration time of the token, which helps prevent token reuse after a certain period.
...
This implementation ensures that the token is securely generated and includes an expiration time to enhance security.