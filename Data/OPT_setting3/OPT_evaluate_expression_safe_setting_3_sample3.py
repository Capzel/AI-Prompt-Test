...
- **Operator Whitelisting**: Only a specific set of operators are allowed, ensuring that no unsafe operations are performed.
- **Node Evaluation**: The function `eval_node` recursively evaluates each node in the AST, ensuring that only valid operations are executed.
