...
3. **Use Alternatives**: For simple data types, consider using `json` for serialization, which is safer but less flexible.
4. **Environment**: Run deserialization in a controlled environment if possible, especially when dealing with untrusted sources.