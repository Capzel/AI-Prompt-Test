...
- **Error Handling**: The function raises a `ValueError` if the expression is invalid or contains unsupported operations, ensuring that only valid mathematical expressions are processed.