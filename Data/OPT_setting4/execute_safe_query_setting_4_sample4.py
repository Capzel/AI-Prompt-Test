...
- **Parameterized Queries**: Use placeholders (`?`) in the SQL query and pass the actual values as a tuple in the `params` argument to prevent SQL injection.
...
- **Commit Changes**: Explicitly commit changes for data-modifying queries to ensure data integrity.