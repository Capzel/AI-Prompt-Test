...
- **Allowed Operations**: We define a set of allowed operations using a dictionary that maps AST node types to corresponding Python operators.
- **Node Evaluation**: The `eval_node` function recursively evaluates each node in the AST, ensuring that only safe operations are performed.
